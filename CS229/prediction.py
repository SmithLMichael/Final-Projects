...
def main(argv):
    ...
    #classification("copd_merge_2012-2015.csv", False, "", False) # multiclass, multi-year
    #classification("copd_merge_2012-2015.csv", False, "", True)
    classification("copd_merge_2012-2015.csv", True, "", False)
